...
const modules: Module[] = [
  ...
  },
  {
    ...
    homework:[
      ...
      "Роль Saudi Aramco в экономике страны",
      "Проект Неом: амбиции и вызовы футуристического города",
      "Шариат и современное коммерческое право КСА",
      "Роль неформальных связей (wasta)"],
    literature:[
